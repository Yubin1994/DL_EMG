...
SemgModel.load_weights('emgModel_7cls_10x10_50ms.h5',by_name = True)

result = SemgModel.predict(X_test) #得到结果
pred = np.argmax(result,axis = 3)
pred = pred.reshape(label_test.shape)
lengthY,lengthRow = pred.shape
